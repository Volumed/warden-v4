...
export const EVENT_HANDLER_AUTHORIZATION = assertEnv(
	"EVENT_HANDLER_AUTHORIZATION",
);

export const EVENT_HANDLER_HOST = assertEnv("EVENT_HANDLER_HOST");
export const EVENT_HANDLER_PORT = parseNumber(
	assertEnv("EVENT_HANDLER_PORT"),
	"EVENT_HANDLER_PORT",
);
...
export const TOTAL_SHARDS = process.env.TOTAL_SHARDS
	? parseNumber(process.env.TOTAL_SHARDS, "TOTAL_SHARDS")
	: undefined;
export const SHARDS_PER_WORKER = parseNumber(
	process.env.SHARDS_PER_WORKER ?? "16",
	"SHARDS_PER_WORKER",
);
export const TOTAL_WORKERS = parseNumber(
	process.env.TOTAL_WORKERS ?? "4",
	"TOTAL_WORKERS",
);

export const GATEWAY_AUTHORIZATION = assertEnv("GATEWAY_AUTHORIZATION");
export const GATEWAY_HOST = assertEnv("GATEWAY_HOST");
export const GATEWAY_PORT = parseNumber(
	assertEnv("GATEWAY_PORT"),
	"GATEWAY_PORT",
);
